				...
				<div className="grid gap-8 lg:grid-cols-2 lg:gap-16">
					<div>
						<Image
							src="/avatar.png"
							alt="OwenStack"
							className="mx-auto aspect-square overflow-hidden rounded-xl object-cover lg;mx-0"
							height={600}
							width={600}
							priority
						/>
					...
					<div>
						<h1
							className={`text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl ${header.className}`}
						>
